...
def search_command():
    ...
    rows = core.search(app.txtNone.get(), app.txtSobrenome.get(), app.txtEmail.get(), app.txtCpf.get())
...
def update_command():
    ...
    core.update(selected[0], app.txtNone.get(), app.txtSobrenome.get(), app.txtEmail.get(), app.txtCpf.get())
